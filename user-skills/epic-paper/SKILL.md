---
name: epic-paper
description: Design anything in Paper.design using the Paper MCP. ALWAYS use this skill when Deborah says things like "help me design", "cria um design", "quero fazer um carrossel", "me ajuda a desenhar", "monta um layout", "faz um pitch deck", "cria uma landing page", "design um post", "quero criar no Paper", or any request to visually design something using Paper.design. Also trigger when she mentions artboards, frames, layouts, carousels, slides, or any visual design output. This skill guides the agent to gather the right context, then orchestrate the Paper MCP tools to build the design step by step.
---
